...
router.register(r'users/summary', views.UsersSummary),
...
router.register(r'job-grades', views.JobGradeViewset),
...
urlpatterns = [
    ...
    path(
        'assessments/user/<int:user_id>/assessment-period/<int:assessment_period>/',
        views.AssessmentsByUser.as_view({'get': 'list'})
    ),
]
